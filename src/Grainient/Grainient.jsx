...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      // The canvas is full-screen and intentionally soft/grainy, so rendering
      // above 1.25 DPR adds considerable GPU fill cost with little visual gain.
    ...
    const tryStart = () => {
      if (motionAllowed && isVisible && isPageVisible && raf === 0) raf = requestAnimationFrame(loop);
    };
    const tryStop = () => {
